...
import coldemailautomationlogo from '../../assets/ColdEmailGeneratorlogo.webp'
function Projects() {
  return (
    <section id="projects" className={styles.container}>
        <h1 className="sectionTitle">Academic Projects</h1>
        <div className={styles.projectContainer}>
        <ProjectCard src={coldemailautomationlogo} link={"https://github.com/RajAdroja/Cold-Email-Generator"} h3={"LLM Project"} p={"Cold Email Generator"}/>
          ...
          <ProjectCard src={db2apilogo} link={"https://github.com/RajAdroja/db2api"} h3={"db2api"} p={"Schema Translation"}/>
